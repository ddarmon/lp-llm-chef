...
from mealplan.db.queries import OptimizationRunQueries
from mealplan.optimizer.constraints import deserialize_profile_json
...
def run_whatif_analysis(
    ...
    """
    from mealplan.optimizer.models import FoodConstraint
