...
class LLMNError(Exception):
    """Base exception for llmn errors."""

    pass


class InfeasibleDietError(LLMNError):
...
class MissingDataError(LLMNError):
    """Raised when required data is missing."""

    pass


class InvalidProfileError(LLMNError):
