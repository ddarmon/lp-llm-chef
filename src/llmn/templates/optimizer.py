...
from llmn.optimizer.multiperiod_models import MealType
from llmn.templates.definitions import get_template_for_patterns
...
from llmn.templates.selector import select_foods_for_template
